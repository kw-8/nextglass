...
class WineIndex extends React.Component {
  ...
  render() {
    ...
    if (!wines || wines.length < 50) return (<img className="loading-gif" src="https://mir-s3-cdn-cf.behance.net/project_modules/1400_opt_1/be585d49104437.58ab53277e681.gif"></img>);
